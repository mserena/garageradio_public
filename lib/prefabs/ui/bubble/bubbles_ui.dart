...
class BubblesUI extends StatefulWidget {
	final double width;
	final double height;
	...
	const BubblesUI({
		...
		this.size = defBubbleExtendedSize,
		this.paddingX = 10,
		this.paddingY = 10,
	...
	@override
	BubbleUIState createState() => BubbleUIState();
}

class BubbleUIState extends State<BubblesUI> {
	double _middleX = 0;
	double _middleY = 0;
	double _offsetX = 0;
	double _offsetY = 0;
